		...
		if(empty($buscar)){
		 ...
		 <script type="text/javascript">
		   ...
		   function ActualizarMiniListaCarrito(){
		 	...
		 	function BorrarFavoritoListadoDoble(t_id_div,t_idu,t_idp){
		 		//alert("BorrarFavoritoListado: "+t_id_div+"      "+t_idu);
		 		...
		 		$("#bigfavorito"+t_idp).hide();
		 		//$("#regalar_corazon_"+t_idp).hide();
		 		$("#regalar_corazon_"+t_idp).css("background-image", "url('corazon-favorito-sin-agregar.png')"); 
		 		//regalar_corazon_
		 	}
		 ...
		 <div class="alert_agregar_carrito" id="alert_agregar_carrito">
		 	...
		 	<div class="alert_agregar_carrito_w">
		 		<div class="alert_agregar_carrito_w_txt">Esto te podría encantar</div>
		 		...
		 		<div>
		 			...
		 			<div class="alert_agregar_producto_rel"  onmouseover="SuspenderSalidaAgregarCarrito();">
		 				<div style="width: 50%; height: 120px; background-color: #fff; float: left;">
		 					<img src="http://pluralmkt.mx/xmlfotos/fotos4/400_7352-17352002000-NEGRO.jpg" style="width: 100%;" />
		 				</div>
		 				<div style="width: 50%; height: 120px; background-color: #fff; float: left;">
		 ...
		 <div  class="over_logins" id="menu_over_favoritos" style="display: none; height: 400px; width: 400px;" onmouseleave="HideThisDiv(this);" >
		 	...
		 	<div style="padding: 10px; height: 350px; overflow-y: scroll; padding-top: 20px; padding-bottom: 20px;" id="favoritos_div_int">
		 		...
		 		if(isset($_SESSION['id_login'])){
		 			...
		 			$idu = $usr_tmp_idu;
		 			$tit = "Favoritos de temporal <br><br>";
		 		}
		 		?>

		 		<div style="text-align: center; border-bottom: solid 1px #dedede; padding-bottom: 8px; font-size: 18px;">
		 			<?php echo $tit; ?>
		 		</div>
		 		...
		 		<div style="border-bottom: 1px solid #dedede;" id="minifavorito<?php echo $id_producto; ?>">
		 				...
		 				<div style="float: left; width: 50%; padding-top: 20px;">
		 					...
		 					<div style="font-size: 15px; width: 80%; font-weight: 600; margin-bottom: 5px;" ><?php echo $type." ".$name; ?></div>

		 					<div style="margin-bottom: 5px;">SKU: <?php echo $ref; ?></div>

		 					<div>Precio desde: <b>$<?php echo $precio; ?></b>  </div>

		 					<div>
		 						<img src="/graficos/carrito_mini_agregar_icon_mini.png" style="width: 30px; ">
		 					</div>
		 				...
		 				<div style="float: left; width: 10%;">
		 					<div class="boton_eliminar_mini_carrito" style="margin-top: 40px;" 

		 					onclick="BorrarFavoritoListadoDoble('minifavorito<?php echo $id_producto; ?>',<?php echo $idu; ?>,<?php echo $id_producto ?>);"

		 					>
			 						<img src="/graficos/mini_carrito_x_borrar_eliminar.png" style="width: 100%; ">
			 				</div>
		 				</div>
		...
		<style type="text/css">
		 	...
		 	*/
		 	...
		 	.boton_eliminar_mini_carrito:hover{
		 		-webkit-box-shadow: 2px 2px 2px 0px rgba(71,70,71,0.5);
				-moz-box-shadow: 2px 2px 2px 0px rgba(71,70,71,0.5);
				box-shadow: 2px 2px 2px 0px rgba(71,70,71,0.5);
		 	}
		  ...
		  <div  class="over_logins" id="menu_over_carrito" style="display: none; height: 600px; width: 400px;" onmouseleave="HideThisDiv(this);" >

		  	<div style="width: 90%; margin: auto; margin-top: 10px; padding-bottom: 15px;">

			  	<div style="border-bottom: solid 1px #ccc; padding-bottom: 15px; padding-top: 10px;" >
			  		<div style="float: left; font-size: 18px; font-weight: 300;">Articulos</div>
			  		<div style="float: right; font-size: 18px;">
			  			<a href="sdm_carrito_03.php" style="color: #000; text-decoration: none;">Ver mi carrito</a>
			  		</div>
			  		<div style="clear: both;"></div>
			  	</div>
			 				...
			 				<div style="float: left; width: 60%;">
			 					...
			 					<div>
			 						<div style="float: left;">
			 							<select style="border: solid 1px #ccc; border-radius: 10px; width: 120px;">
			 								<?php
			 						...
			 						<div style="float: left; margin-left: 5px;">
			 							<input style="border: solid 1px #ccc; border-radius: 10px; width: 40px; text-align: center;"
			 							 type="cant" value="5" name="cant<?php echo $id_producto; ?>">
			 						</div>
			 						<div style="clear: both;"></div>
			 					</div>
			 	...
			 	<div>
			 		<div style="width: 95%; margin: auto;">
		 				...
		 				<div style="width: 95%; margin: auto;">
		 					  ...
		 					  <div class="boton_azul" value="Proceder al pago">Proceder al pago</div>
 		...
 		<div class="top" onclick="HideAllSubMenus();" onmouseover="HideAllSubMenus();">
 			...
 			<div class="top_buscador">
 				...
 				<div class="top_buscador_int">
 					<div class="top_buscador_txt" style="width: 475px;">
 						<input type="text" name="buscar" style=" width: 450px;" placeholder="¿Qué regalo publicitario estás buscando?" value="<?php echo $buscar; ?>" >
 					</div>
 			 ...
 			 function ElSize(){
		    	ww=$( window ).width();
			  	...
			  	if(ww>1240){
			  		...
			  		$(".over_logins_carrito").css("right",(t_df+50)+"px");
			...
			<?php } ?>
				...
				<?php } ?>
					...
					<?php 
							...
							$cccs=0;
				            $sql  = "SELECT * FROM `categoria` WHERE `id_padre` = '$id'  AND visible='1'  ORDER BY `columna`,`orden` ASC";
					...
					?>
							...
							<?php   if($imagen=="" && $cccs == 1  ){ 
										//$cccs=0;
							 ?>
							<div style="width: 24%; float: left; background-color: #fff;">
							<?php  }   ?>
