 			 ...
 			 <div class="regalar_int">
	 			 ...
	 			 <div >
	 			 	<div style="background-color: #fff;">
						...
						$sy = "SELECT * FROM `xml_producto_categoria` WHERE `id_categoria` = '$xml_id_categoria' LIMIT 9";
						...
						$sz = " SELECT * FROM `xml_productos_clon` WHERE `id_producto` = '$xml_id_producto' LIMIT 1";
						...
						?>
		 			 	...
		 			 	<div class="regalar_element">
		 			 		...
		 			 		<div class="regalar_corazon">
		 			 			<img src="sdm_corazon.png" style="width: 100%;">
		 			 		</div>
		 			 		...
		 			 		<div class="regalar_titulo"><?php echo $name; ?></div>
		 			 		<div>SKU: <?php echo $ref; ?></div>
		 			 		<div class="regalar_precio">Precio desde: $<?php echo $precio; ?>.00</div>


		 			 		<?php
		 			 			if($colores_cantidad>8){
		 			 				$colores_cantidad=8;
		 			 			}
		 			 			$ancho_colores = 18*$colores_cantidad;
		 			 		?>

		 			 		<div style="margin: auto; width: <?php echo $ancho_colores; ?>px; margin-top: 10px;">
		 			 			...
		 			 			?>
		 			 					...
		 			 					<div class="regalar_circulo_color" style="background-color: <?php echo $valor; ?>;"></div>
