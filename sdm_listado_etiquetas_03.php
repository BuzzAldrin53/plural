...
<?php
$sq = "SELECT * FROM `etiqueta` WHERE id_etiqueta='$idetiqueta' ";
$resultt = $mysqli->query($sq);
while ($roww = $resultt->fetch_row()){
	//echo "- ".$roww[1]." <br> ";
	$etiqueta_nombre = $roww[1];
}
?>
...
<head>
	...
	<title>Etiqueta <?php echo $etiqueta_nombre; ?> - Plural</title>    
 		...
 		<div class="regalar">
 			 ...
 			 <div class="regalar_int">
	 			...
	 			<?php
	 			 ...
	 			 <div class="regalar_tit">Etiqueta <span style="font-weight: 600;"><?php echo $etiqueta_nombre; ?></span> </div>
	 			 ...
	 			 <div >
	 			 	<div style="background-color: #fff;">
						...
						$sy = "SELECT * FROM `etiqueta_xml_producto` WHERE id_etiqueta = '$idetiqueta' ";
						...
						?>
		 			 	...
		 			 	<div class="regalar_element">
		 			 		...
		 			 		<div  class="regalar_corazon" id="regalar_corazon_<?php echo $id_producto; ?>"
		 			 		 onclick="AgregarAFavoritos(<?php echo $xml_id_producto; ?>,this);"   >
		 			 		...
		 			 		<div  class="regalar_corazon" id="regalar_corazon_<?php echo $id_producto; ?>" style="background-image: url('corazon-favoritos-agregado.png');" 
		 			 		...
		 			 		<div class="regalar_element_div" >
		 			 			<a href="sdm_detalle_03.php?xml_id_producto=<?php echo $xml_id_producto; ?>&idcat=<?php echo $idcat; ?>">
		 			 				<img width="260" src="<?php echo $imagen400; ?>" >
		 			 			</a>
		 			 		</div>
