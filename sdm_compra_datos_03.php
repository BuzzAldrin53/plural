 			...
 			function Validar(){
 				...
 				if( $('#quieres_facturar').prop('checked') ) {
				    ...
				    if( $("#persona_fisica").val()=="" ){
				    	error = 1;
				    	$("#alertas").append("- Debes confirmar si eres persona física <br>");
				    }
				    if( $("#razon_social").val()=="" ){
				    	error = 1;
				    	$("#alertas").append("- Debes ingresar tu razón social <br>");
				    }
...
if(!isset($correo)){
 ...
 ?>
 		...
 		<div class="contenido">
 			...
 			<div style="width: 60%; margin: auto;">
 				<div style="width: 50%; float: left;">
 					<input class="class_input" type="text" name="correo" id="correo" placeholder="Correo electrónico" value="<?php if(isset($t_correo)){  echo $t_correo;    } ?>">
 				</div>
 				<div style="width: 50%; float: left;">
 			...
 			<br><br><br>
  			...
  			<div style="width: 60%; margin: auto;">
 				<div style="width: 50%; float: left;">
 					<input class="class_input" type="text" name="razon_social" id="razon_social" placeholder="Razón social">
 				</div>
 				<div style="width: 50%; float: left;">
 			...
 			<div style="width: 60%; margin: auto;">
 				<div style="width: 50%; float: left;">
 					<input class="class_input" type="text" name="persona_fisica" id="persona_fisica" placeholder="Persona física o moral">
 				</div>
