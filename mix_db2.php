...
<?php
	...
	$sql = " SELECT * FROM `xml_productos` WHERE `estatus` = '1' LIMIT 200 ";
	...
	while ($row = $resultt->fetch_row()){
	   ...
	   $sql = " SELECT * FROM `table_45` WHERE `ref` LIKE '$ref' ";
	   echo $sql;
	   ...
	   if($conta>0){
	   		...
	   		$sql = " UPDATE `xml_productos` SET `estatus` = '2' WHERE `xml_productos`.`id_producto` = '$id_producto' ;  ";
	   		echo $sql;
