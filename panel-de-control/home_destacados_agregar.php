			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form action="home_destacados_agregar_form.php"  enctype="multipart/form-data" method="POST">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Color de fondo (#A4A2FA)</label>
									<div class="col-lg-10">


									<div class="d-inline-block">
									<input type="text" class="form-control colorpicker-flat-full" data-preferred-format="hex" value="#A4A2FA" data-fouc name="color">
									</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Tamaño de la fuente (17 default)</label>
									<div class="col-lg-10">
										<input  type="text" class="form-control"  autocomplete="off" value="17" name="size">
									</div>
								</div> 
