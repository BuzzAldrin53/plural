		...
		<div class="content-wrapper">
								...
								<div class="form-group row">
		                        	...
		                        	<div class="col-lg-10">
			                            <select class="form-control" name="id_padre">
			                                ...
			                                <option value="<?php echo $id_categoria; ?>"  <?php echo $sel; ?> ><?php echo $nombre; ?></option>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						La lista de <code>PRODUCTOS</code> descargados del <code>XML</code>.
					</div>
					...
					<table class="table datatable-basic">
                        ...
                        <?php 
                         ...
                         $qt = "SELECT * FROM xml_productos LIMIT 200 ";
