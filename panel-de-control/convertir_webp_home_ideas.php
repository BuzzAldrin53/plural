...
include_once("db.php");
	...
	$qt = "  SELECT count(*) FROM `home_ideas` WHERE elestatus =1  ";
    ...
    $qt = "  SELECT count(*) FROM `home_ideas` WHERE elestatus =0  ";
     ...
     $qt = "  SELECT * FROM `home_ideas` WHERE elestatus =0 LIMIT 1  ";
...
$qt = " UPDATE `home_ideas` SET `elestatus` = '1' WHERE `home_ideas`.`id_ideas` = '$id'; ";
$resultt = $mysqli->query($qt);
