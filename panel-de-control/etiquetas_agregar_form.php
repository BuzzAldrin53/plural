			...
			<div class="content">
				...
				<div class="card">
					...
					if(!isset($editar)){
						...
						$qt = "INSERT INTO `etiqueta` (`id_etiqueta`, `nombre`, `id_categoria`, `datos`, `nombre_publico`, `imagen`)
						 VALUES (NULL, '$nombre', '0', '', '$nombre_publico', '$url');";
						 echo $qt;
