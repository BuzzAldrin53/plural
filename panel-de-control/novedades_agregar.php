			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Novedades Agregar</h5>
					...
					<div class="card-body">
						...
						<form action="novedades_agregar_form.php"  enctype="multipart/form-data" method="POST">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Url (http://pluralmkt.com/)</label>
									<div class="col-lg-10">
								...
								<legend class="text-uppercase font-size-sm font-weight-bold">Archivo (.jpg) (Proporción relativa a 1920x2820)</legend>
