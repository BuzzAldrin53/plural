			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Documento agregado (<?php echo $nombre; ?>)</h5>
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        if($tmpFile!=""){
	                        ...
	                        $url_img = "https://adek.com.mx/losuploads/".$archivo;
							...
							imagejpeg($thumb, '../losuploads/'.$elancho.'_'.$archivo ,95);

							if($extension=="png"){
								imagejpeg($thumb, '../losuploads/'.$solonombre.".jpg" ,95);
							}
							
							//
							imagewebp($origen, '../losuploads/'.$solonombre.".webp" ,95);
							imagewebp($thumb, '../losuploads/'.$elancho.'_'.$solonombre.".webp" ,95);
					...
					if(!isset($editar)){
						 ...
						 $qt = " INSERT INTO `contenido_productos` (`id_producto`, `titulo`, `nombre`, `imagen`, `permalink`, `url`, `orden`, `introduccion`, `descripcion`)
						  VALUES (NULL, '$titulo', '$nombre', '$url_img', '$permalink', '$url','$orden','$introduccion','$descripcion'); ";
						...
						$qt = "UPDATE `contenido_productos`
						 SET `titulo` = '$titulo', `nombre` = '$nombre',
						  `imagen` = '$url_img',
						   `permalink` = '$permalink',
						   `url` = '$url',
						 ...
						 WHERE `contenido_productos`.`id_producto` = '$id';";
					...
					<div class="card-body">
						<p class="mb-4">
							...
							Este documento ha sido agregado a la <code>Intranet</code>
						...
						<div>
                            ...
                            <div style="margin: 20px; margin-botttom:50px;">
                                    ...
                                    <div style="margin: 20px; margin-botttom:50px; float: left; width: 180px; height: 250px; text-align: center;">
                                        ...
                                        <a href="<?php echo $url_img; ?>" target="_blank">
                                            <img src="<?php echo $icono; ?>" height="220">
                                        </a>

                                        <br><br>

                                        <a href="<?php echo $url_img; ?>" download >
                                            Descargar
                                        </a>
