...
<head>
	...
	<script type="text/javascript">
		...
		function Eliminar(t_id,t_completo){
			...
			var r = confirm("Estás seguro que deseas eliminar: "+t_completo);
			if (r == true) {
			  txt = "You pressed OK!";

			  	$.ajax({url: "home_ideas_eliminar.php?id="+t_id, success: function(result){
    				//$("#div1").html(result);
    				//alert(result);
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home Ideas</span> - Listado</h4>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Home Ideas</h5>
					...
					<div class="card-body">
						La lista de <code>Ideas</code> que aparecen en el home (Imagenes de ideas) <code>-</code>.
					</div>
					...
					<table class="table datatable-basic">
                        ...
                        <?php 
                         $qt = "SELECT * FROM home_ideas ORDER BY orden ASC LIMIT 500";
                          ...
                          while ($rowt = $resultt->fetch_row()){
                            ...
                            $ancho =$rowt[8];
	                          ...
	                          $q = "SELECT * FROM home_ideas_categorias WHERE id_categoria='$id_categoria' ";
	                        ...
	                        if($alto<=1){
	                            ...
	                            $laimagen = "../uploads/".$solo_imagen;
	                        	//echo $laimagen;
	                        	list($ancho, $alto) = getimagesize($laimagen);
	                        	//echo "  ".$ancho."  ".$alto;
	                        	$sq = "UPDATE `home_ideas` SET `alto` = '$alto', `ancho` = '$ancho' WHERE `home_ideas`.`id_ideas` = $id;";
	                        	$mysqli->query($sq);
	                        	//echo $sq;
                            }
                        	//////////////////////////////////////////////////////////UPDATE ALTO ANCHO
                        ...
                        ?>  
							<tr id="element<?php echo $id; ?>">
								<td><?php echo $id; ?></td>
								<a link="<?php echo $id; ?>">
								<td><a href="home_ideas_agregar.php?editar=1&id=<?php echo $id; ?>"><?php echo $titulo; ?></td>
								
								<td>

									<img style="width: 150px;" src="<?php echo $imagen; ?>" ></img>
								...
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a href="#<?php echo $id; ?>" class="dropdown-item" onclick="Eliminar(<?php echo $id; ?>,'<?php echo $titulo; ?>');">
													<i class="icon-bin"></i> Remove</a>

												<a href="home_ideas_agregar.php?editar=1&id=<?php echo $id; ?>" class="dropdown-item"><i class="icon-pencil4"></i> Editar</a>
