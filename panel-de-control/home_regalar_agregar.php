			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home Destacados</span> - Agregar</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="novedades.php" class="breadcrumb-item">Home Destacados</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Home destacados Agregar</h5>
					...
					<div class="card-body">
						...
						<form action="home_regalar_agregar_form.php"  enctype="multipart/form-data" method="POST">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input  type="text" class="form-control"  autocomplete="off" value="" name="titulo">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Url ( https://pluralmkt.com/ )</label>
									<div class="col-lg-10">
										<input  type="text" class="form-control"  autocomplete="off" value="" name="link">
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Sku (01234534)</label>
									<div class="col-lg-10">
										<input  type="text" class="form-control"  autocomplete="off" value="0" name="sku">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Precio (99)</label>
									<div class="col-lg-10">
										<input  type="text" class="form-control"  autocomplete="off" value="0" name="precio">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Color 1 (#A4A2FA)</label>
									<div class="col-lg-10">
									<div class="d-inline-block">
									<input type="text" class="form-control colorpicker-flat-full" data-preferred-format="hex" value="#A4A2FA" data-fouc name="color1">
									</div>
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Color de typo (letra,fuente) (#000000)</label>
									<div class="col-lg-10">
									<div class="d-inline-block">
									<input type="text" class="form-control colorpicker-flat-full" data-preferred-format="hex" value="#000000" data-fouc name="color2">
									</div>
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
									<div class="d-inline-block">
									<input type="text" class="form-control colorpicker-flat-full" data-preferred-format="hex" value="#000000" data-fouc name="color3">
									</div>
									</div>
								</div>
