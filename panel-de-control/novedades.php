		...
		function Eliminar(t_id,t_completo){
			...
			if (r == true) {
			  txt = "You pressed OK!";
			  	...
			  	$.ajax({url: "novedades_eliminar.php?id="+t_id, success: function(result){
    				//$("#div1").html(result);
    				//alert(result);
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Novedades</span> - Listado</h4>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						La lista de <code>Novedades</code> que aparecen en el home <code>HOME</code>.
					</div>
                        ...
                        ?>  
							<tr id="element<?php echo $id; ?>">
								...
								<td>
										...
										<div class="novedades_elem" style="background-image: url(<?php echo $imagen; ?>); width: 190px;">
