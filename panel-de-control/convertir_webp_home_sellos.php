...
include_once("db.php");
	...
	$qt = "  SELECT count(*) FROM `home_sellos` WHERE elestatus =1  ";
    ...
    $qt = "  SELECT count(*) FROM `home_sellos` WHERE elestatus =0  ";
     ...
     $qt = "  SELECT * FROM `home_sellos` WHERE elestatus =0 LIMIT 1  ";
...
$qt = " UPDATE `home_sellos` SET `elestatus` = '1' WHERE `home_sellos`.`id_home_logos` = '$id'; ";
$resultt = $mysqli->query($qt);
