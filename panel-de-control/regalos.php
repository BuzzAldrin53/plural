		...
		function Eliminar(t_id,t_completo){
			...
			if (r == true) {
			  txt = "You pressed OK!";
			  	...
			  	$.ajax({url: "regalos_eliminar.php?id="+t_id, success: function(result){
    				//$("#div1").html(result);
    				//alert(result);
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Regalos perfectos</span> - Listado</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="novedades.php" class="breadcrumb-item">Regalos perfectos</a>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						La lista de <code>Regalos perfectos</code> que aparecen en el home <code>HOME</code>.
					</div>
                        ...
                        ?>  
							<tr id="element<?php echo $id; ?>">
								...
								<td>
										...
										<div class="encuentra_element" style="background-image: url(<?php echo $imagen; ?>); width: 150px;">
