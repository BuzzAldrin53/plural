			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Documentos</span> - Agregar</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="usuarios.php" class="breadcrumb-item">Documentos</a>
				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-4">
							...
							En esta interface puede agregar documenos nuevos para la intranet <code>Intranet</code>

						</p>

						<form action="documentos_agregar_form.php"  enctype="multipart/form-data" method="POST">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Rellena los campos</legend>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Titulo del documento</label>
									<div class="col-lg-10">
                                ...
                                <div class="form-group row">
									<label class="col-form-label col-lg-2">Descripción del documento</label>
									<div class="col-lg-10">
										<textarea name="descripcion" style="width: 100%; height: 150px;"></textarea>
									</div>
								</div>
								...
								<legend class="text-uppercase font-size-sm font-weight-bold">Archivo (.doc, .pdf, .xls, .docx)</legend>
