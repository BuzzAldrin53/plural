			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home Ideas</span> - Agregar</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="novedades.php" class="breadcrumb-item">Home Ideas</a>
			...
			<!-- /page header -->
			 ...
			 <?php 
			 	if(isset($editar) && isset($id) ){
                         $qt = "SELECT * FROM home_ideas WHERE id_ideas = '$id' LIMIT 1 ";
                          ...
                          while ($rowt = $resultt->fetch_row()){
                            ...
                            echo "<br><h1 style='margin-left:50px;'>".$titulo."</h1>";
                          }
                 }
              ?>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Home Ideas Agregar</h5>
					...
					<div class="card-body">
						...
						<form action="home_ideas_agregar_form.php"  enctype="multipart/form-data" method="POST">
							...
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input  type="text" class="form-control"  autocomplete="off"  name="titulo" value="<?php if(isset($titulo)) { echo $titulo; } ?>">
									</div>
								</div>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input  type="text" class="form-control"  autocomplete="off"  name="link" value="<?php if(isset($link)) { echo $link; } ?>">
									</div>
								</div>
		                        ...
		                        <div class="form-group row">
		                        	<label class="col-form-label col-lg-2">Categoria de Idea de Home</label>
		                        	<div class="col-lg-10">
			                            <select class="form-control" name="id_categoria">
			                            	 

			                            	 <?php 
					                         $qt = "SELECT * FROM home_ideas_categorias ORDER BY orden ASC LIMIT 30";
			                                ...
			                                <option <?php echo $sel; ?> value="<?php echo $id_nivel; ?>"><?php echo $nombre_nivel; ?></option>
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input  type="text" class="form-control"  autocomplete="off" name="orden" value="<?php if(isset($orden)) { echo $orden; } ?>">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Columna (1,2,3)</label>
									<div class="col-lg-10">
										<input  type="text" class="form-control"  autocomplete="off"  name="columna" value="<?php if(isset($columna)) { echo $columna; } ?>">
									</div>
								</div>
