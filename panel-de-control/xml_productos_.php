				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-4">
							...
							En esta interface puede listar los productos del <code>XML</code>
						...
						<form action="xml_productos_.php">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									...
									<div class="col-lg-10">
										<input  type="text" class="form-control"  autocomplete="off"  name="elnombre" value="<?php echo $elnombre; ?>">
									</div>
								</div>
							...
							<div class="text-right">
								<button type="submit" class="btn btn-primary">Buscar <i class="icon-paperplane ml-2"></i></button>
							</div>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<?php
                         ...
                         $qt = "SELECT count(*) FROM xml_productos WHERE name LIKE '%$elnombre%' OR type LIKE '%$elnombre%'  ";
                         //echo $qt;
						...
						<b><?php echo $contadr; ?></b> Resultados de la busqueda de: '<?php echo $elnombre; ?>''
					</div>
					...
					<table class="table datatable-basic">
                        ...
                        <?php 
                         ...
                         $qt = "SELECT * FROM xml_productos WHERE name LIKE '%$elnombre%' OR type LIKE '%$elnombre%' LIMIT 500 ";
