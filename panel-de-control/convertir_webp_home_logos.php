...
include_once("db.php");
	...
	$qt = "  SELECT count(*) FROM `home_logos` WHERE elestatus =1  ";
    ...
    $qt = "  SELECT count(*) FROM `home_logos` WHERE elestatus =0  ";
     ...
     $qt = "  SELECT * FROM `home_logos` WHERE elestatus =0 LIMIT 1  ";
...
$qt = " UPDATE `home_logos` SET `elestatus` = '1' WHERE `home_logos`.`id_home_logos` = '$id'; ";
$resultt = $mysqli->query($qt);
