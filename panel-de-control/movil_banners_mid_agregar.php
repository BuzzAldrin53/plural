			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Móvil Banners Medium</span> - Agregar</h4>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Móvil Banners Medium Agregar</h5>
					...
					<div class="card-body">
						...
						<form action="movil_banners_mid_agregar_form.php"  enctype="multipart/form-data" method="POST">
							<fieldset class="mb-3">
