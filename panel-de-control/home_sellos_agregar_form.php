			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Sello</span> - Agregar</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="usuarios.php" class="breadcrumb-item">Sello </a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Sello agregado (<?php echo $nombre; ?>)</h5>
					 ...
					 */
					 ...
					 $qt = "INSERT INTO `home_sellos` (`id_home_logos`, `nombre`, `imagen`, `url`, `orden`) 
					 VALUES (NULL, '$titulo', '$url', '$link', '$orden');";
					...
					<div class="card-body">
						<p class="mb-4">
							...
							Este sello ha sido agregado a la <code>Intranet</code>
