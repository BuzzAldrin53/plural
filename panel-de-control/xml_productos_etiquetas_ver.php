	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form action="xml_productos_etiquetas_ver.php">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Mostrar la etiqueta:</label>
									<div class="col-lg-10">
			...
			<div class="content">
                ...
                $qqt="SELECT * FROM `etiqueta_xml_producto` WHERE id_etiqueta='$etiqueta_id' ";  
							...
							<tr id="element<?php echo $id_usuario; ?>">
								...
								<td>
									...
									<?php
				 					 ...
				 					 $sql = "SELECT * FROM `etiqueta_xml_producto` WHERE id_producto='$id_producto' ";
		                             $result = $mysqli->query($sql);
		                         	 while ($rowt = $result->fetch_row()){
		 									$id_etiqueta=$rowt[1];

		 									$sq = "SELECT * FROM `etiqueta` WHERE id_etiqueta='$id_etiqueta' ";
