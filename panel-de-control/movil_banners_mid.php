		...
		function Eliminar(t_id,t_completo){
			...
			if (r == true) {
			  txt = "You pressed OK!";
			  	...
			  	$.ajax({url: "home_banner_mid_eliminar.php?id="+t_id, success: function(result){
    				//$("#div1").html(result);
    				//alert(result);
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Móvil Banners Medium</span> - Listado</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							<a href="index.html" class="breadcrumb-item"><i class="icon-home2 mr-2"></i>Móvil Home</a>
							<a href="novedades.php" class="breadcrumb-item">Móvil Banners Medium</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Móvil Banners Medium</h5>
					...
					<div class="card-body">
						La lista de <code>Banners Medium</code> que aparecen en el <code>Móvil HOME</code>.
					</div>
					...
					<table class="table datatable-basic">
                        ...
                        <?php 
                         $qt = "SELECT * FROM home_movil_banner_mid ORDER BY orden ASC LIMIT 30";
                        ...
                        ?>  
							<tr id="element<?php echo $id; ?>">
								...
								<td>
									...
									<img style="width: 350px;" src="<?php echo $imagen; ?>" ></img>
