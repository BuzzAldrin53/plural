				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="usuarios.php" class="breadcrumb-item">Móvil Banners Medium</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Móvil Banner Medium agregado (<?php echo $nombre; ?>)</h5>
					...
					$qt = "INSERT INTO `home_movil_banner_mid` (`id_banner_mid`, `titulo`, `imagen`, `url`, `orden`)
