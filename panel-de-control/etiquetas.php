...
<head>
	...
	<script type="text/javascript">
		...
		function Eliminar(t_tabla,t_id_name,t_id,t_completo){
			//alert("Eliminar; "+t_id);
			...
			if (r == true) {
			  txt = "You pressed OK!";
			  	...
			  	$.ajax({url: "eliminar_tabla_id.php?tabla="+t_tabla+"&id_name="+t_id_name+"&id="+t_id, success: function(result){
    				//$("#div1").html(result);
    				//alert(result);
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Etiquetas</span> - Listado</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="etiquetas.php" class="breadcrumb-item">Etiquetas</a>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						La lista de <code>Etiquetas</code> que aparecen en el home <code>HOME</code>.
					</div>
					...
					<table class="table datatable-basic">
                        ...
                        $qt = "SELECT * FROM etiqueta ORDER BY etiqueta.nombre ASC LIMIT 30";
                        ...
                        ?>  
							<tr id="element<?php echo $id; ?>">
								<td><?php echo $id; ?></td>
								<a link="<?php echo $id; ?>">
								<td><a href="etiquetas_agregar.php?editar=1&id=<?php echo $id; ?>"><?php echo $titulo; ?></td>

								<td><?php echo $nombre_publico; ?></td>
								...
								<td>
									...
									if($imagen!=""){
									 ...
									 ?>
									 <img width="200" src="<?php echo $imagen; ?>">
									<?php 
									}else{
										echo "-";
									}
								...
								<td class="text-center">
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a href="#<?php echo $id; ?>" class="dropdown-item"
												  onclick="Eliminar('etiqueta','id_etiqueta',<?php echo $id; ?>,'<?php echo $nombre." ".$nombre_publico; ?>');"  >
													<i class="icon-bin"></i> Remove</a>


												<a href="etiquetas_agregar.php?editar=1&id=<?php echo $id; ?>" class="dropdown-item"><i class="icon-pencil4"></i> Editar</a>
