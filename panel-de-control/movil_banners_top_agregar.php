			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Movil Banners Top</span> - Agregar</h4>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Movil Banners Top Agregar</h5>
					...
					<div class="card-body">
						...
						<form action="movil_banners_top_agregar_form.php"  enctype="multipart/form-data" method="POST">
							<fieldset class="mb-3">
