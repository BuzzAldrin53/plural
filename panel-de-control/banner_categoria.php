		...
		function Eliminar(t_id,t_completo){
			...
			if (r == true) {
			  txt = "You pressed OK!";
			  	...
			  	$.ajax({url: "banner_categoria_eliminar.php?id="+t_id, success: function(result){
    				//$("#div1").html(result);
    				//alert(result);
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Banners de categorias</span> - Listado</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="novedades.php" class="breadcrumb-item">Baner de categorias</a>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						La lista de <code>banners de categoria</code> que aparecen en el home <code>-</code>.
					</div>
					...
					<table class="table datatable-basic">
                        ...
                        <?php 
                         $qt = "SELECT * FROM categoria_banner ORDER BY id_categoria_banner ASC LIMIT 500";
                          ...
                          while ($rowt = $resultt->fetch_row()){
                            ...
                            $orden=$rowt[3];
                             ...
                             $q = "SELECT * FROM categoria WHERE id_categoria='$id_cat' ";
