				...
				<div class="card">
					...
					<div class="card-body">
						<p class="mb-4">
							...
							En esta interface puede agregar categorias nuevas al <code>Intranet</code>

						</p>

						<form action="categoria_agregar_form.php">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Rellena los campos</legend>


								<div class="form-group row">
									<label class="col-form-label col-lg-2">Categoria Padre</label>
		                        	<div class="col-lg-10">
			                            <select class="form-control" name="id_padre">
			                            	 <option value="0">-</option>

			                            	 <?php 
					                         $qt = "SELECT * FROM categoria ORDER BY id_categoria DESC LIMIT 50";
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Permalink</label>
									<div class="col-lg-10">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Nombre HTML</label>
									<div class="col-lg-10">
										<input type="text" class="form-control"  name="nombre_html">
									</div>
								</div>

								<div class="form-group row">
									<label class="col-form-label col-lg-2">Orden</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="###" name="orden" >
									</div>
								</div>
