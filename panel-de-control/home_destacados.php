		...
		function Eliminar(t_id,t_completo){
			...
			if (r == true) {
			  txt = "You pressed OK!";
			  	...
			  	$.ajax({url: "home_destacados_eliminar.php?id="+t_id, success: function(result){
    				//$("#div1").html(result);
    				//alert(result);
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home destacados</span> - Listado</h4>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Home destacados</h5>
					...
					<div class="card-body">
						La lista de <code>destacados</code> que aparecen en el home <code>-</code>.
					</div>
					...
					<table class="table datatable-basic">
						<thead>
							<tr>
								...
								<th>Color de typo (letra,fuente)</th>
								<th>Tamaño de typo (letra,fuente)</th>
                        ...
                        <?php 
                         $qt = "SELECT * FROM home_destacados ORDER BY orden ASC LIMIT 30";
                        ...
                        ?>  
							<tr id="element<?php echo $id; ?>">
								<td><?php echo $id; ?></td>
								<a link="<?php echo $id; ?>">
								<td><a href="novedades_editar.php?id=<?php echo $id; ?>"><?php echo $titulo; ?></td>
								...
								<td style="background-color: <?php echo $color2; ?>;"><?php echo $color2; ?></td>
									...
									<div class="list-icons">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a href="usuarios_editar.php?id=<?php echo $id; ?>" class="dropdown-item"><i class="icon-pencil4"></i> Editar</a>
