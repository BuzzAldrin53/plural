		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					$qt = "INSERT INTO `home_regalar_siempre` 
					(`id_home_regalar`, `titulo`, `id_producto`, `orden`, `sku`, `precio`, `imagen`, `color1`, `color2`, `color3`, `fecha_alta`, `url`)
					 VALUES (NULL, '$titulo', '0', '0', '$sku', '$precio', '$url', '$color1', '$color2', '$color3', now() , '$link' );";
