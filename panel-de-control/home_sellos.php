		...
		function Eliminar(t_id,t_completo){
			...
			if (r == true) {
			  txt = "You pressed OK!";
			  	...
			  	$.ajax({url: "home_sellos_eliminar.php?id="+t_id, success: function(result){
    				//$("#div1").html(result);
    				//alert(result);
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Home sellos</span> - Listado</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="novedades.php" class="breadcrumb-item">Home sellos</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Home Logos</h5>
					...
					<div class="card-body">
						La lista de <code>sellos</code> que aparecen en el home (hemos dejado huella en...) <code>-</code>.
					</div>
					...
					<table class="table datatable-basic">
                        ...
                        <?php 
                         $qt = "SELECT * FROM home_sellos ORDER BY orden ASC LIMIT 30";
