		...
		function Eliminar(t_id,t_completo){
			...
			if (r == true) {
			  txt = "You pressed OK!";
			  	...
			  	$.ajax({url: "home_banner_top_eliminar.php?id="+t_id, success: function(result){
    				//$("#div1").html(result);
    				//alert(result);
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Movil Banners top</span> - Listado</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="novedades.php" class="breadcrumb-item">Movil Banners Top</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Móvil Banners top</h5>
					...
					<div class="card-body">
						La lista de <code>Banners top</code> que aparecen en el <code>HOME MOVIL</code>.
					</div>
					...
					<table class="table datatable-basic">
                        ...
                        <?php 
                         $qt = "SELECT * FROM home_movil_banner_top ORDER BY orden ASC LIMIT 30";
