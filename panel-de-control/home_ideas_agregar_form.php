			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Banners Ideas</span> - Agregar</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="usuarios.php" class="breadcrumb-item">Banners Ideas</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						...
						<h5 class="card-title"><a href="home_ideas_agregar.php">Agregar otra Idea al Home</a></h5>
					...
					if(!isset($editar)){
						 ...
						 $qt = "INSERT INTO `home_ideas` (`id_ideas`, `nombre`, `imagen`, `url`, `orden`, `columna`,`id_ideas_categoria`)
					  VALUES (NULL, '$titulo', '$url', '$link', '$orden', '$columna','$id_categoria');";
					  //echo $qt;
					$resultt = $mysqli->query($qt);
						...
						UPDATE `home_ideas` SET 
						`nombre` = '$titulo',
						 `imagen` = '$imagen',
						  `url` = '$link',
						   `titulo` = '$titulo',
						    `descripcion` = '$descripcion',
						    `id_ideas_categoria` = '$id_categoria' 

						     WHERE `home_ideas`.`id_ideas` = '$id' ; 
