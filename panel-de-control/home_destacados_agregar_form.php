			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Banners Top</span> - Agregar</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="usuarios.php" class="breadcrumb-item">Banners Top</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Banner Top agregado (<?php echo $nombre; ?>)</h5>
                    ...
                    /*
					$qt = "INSERT INTO `home_logos` (`id_banner_top`, `titulo`, `imagen`, `url`, `orden`)
					 VALUES (NULL, '$titulo', '$url', '$link', '$orden');";
					 */

					 /*
					 $qt = "INSERT INTO `home_logos` (`id_home_logos`, `nombre`, `imagen`, `url`, `orden`) 
					 VALUES (NULL, '$titulo', '$url', '$link', '$orden');";
					 */

					 $qt = "INSERT INTO `home_destacados` (`id_home_destacado`, `nombre`, `imagen`, `url`, `orden`, `color`, `color2`, `size`)
					  VALUES (NULL, '$titulo', '$url', '$link', '$orden', '$color', '$color2', '$size');";
					...
					<div class="card-body">
						<p class="mb-4">
							...
							Este logo ha sido agregado a la <code>Intranet</code>
