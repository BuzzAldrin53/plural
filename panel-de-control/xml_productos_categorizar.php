			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<form action="xml_productos_categorizar.php">
							<fieldset class="mb-3">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<?php
                         ...
                         $qt = "SELECT count(*) FROM xml_productos WHERE type LIKE '$buscar' OR type_local LIKE '$buscar' OR ref LIKE '$buscar' OR extendedinfo LIKE '$buscar' LIMIT 500  ";

                         if($exacta=="1" or $exacta=="11"){
                         	 $qt = "SELECT count(*) FROM xml_productos WHERE type LIKE '$buscar' OR type_local LIKE '$buscar' OR ref LIKE '$buscar' OR extendedinfo LIKE '$buscar'  ";
                         }
					...
					<table class="table datatable-basic">
                        ...
                        <?php 
                         ...
                         $qt = "SELECT * FROM xml_productos WHERE type LIKE '$buscar' OR type_local LIKE '$buscar' OR ref LIKE '$buscar' OR extendedinfo LIKE '$buscar' LIMIT 500";

                         if($exacta=="1" or $exacta=="11"){
                         	 $qt = "SELECT * FROM xml_productos WHERE type LIKE '$buscar' OR type_local LIKE '$buscar' OR ref LIKE '$buscar' OR extendedinfo LIKE '$buscar' ";
                         }
                         if($exacta=="2" or $exacta=="12"){
                         	 $qt = "SELECT * FROM xml_productos WHERE type LIKE '%$buscar%' OR type_local LIKE '%$buscar%' OR ref LIKE '%$buscar%' OR extendedinfo LIKE '%$buscar%'  ";
                         }
