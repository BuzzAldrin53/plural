 	...
 	<div class="content_all">
 		...
 		<div class="top_menu_full">
 				<div class="top_menu_full_int">
 						...
 						<div class="top_menu_full_element" onmouseover="VerSubMenu('menu<?php echo $id; ?>');"><?php echo $titulo; ?></div>
		...
		$resultt = $mysqli->query($sq);
 		...
 		<div class="over_subcategoria" id="menu<?php echo $id; ?>" onmouseleave="HideSubmenu(this);"  >
			...
			<div class="over_subcategoria_der" style="background-image: url('<?php echo $imagen; ?>');">
 	...
 	<div class="elfooter">
 		<div class="elfooter_int">
 			...
 			<div class="footer_letra_chiquita">
				...
				Todos los precios están sujetos a posibles cambios. <br><br>
