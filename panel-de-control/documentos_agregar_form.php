			...
			<div class="content">
				...
				<div class="card">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        ...
                        //$newFile = './uploads/'.$_FILES['file']['name'];
                        ...
                        if($extension=="jpg"){
							...
							//echo "<a href='../uploads/800_".$archivo."' >".$archivo."</a>";
					...
					$qt = "INSERT INTO `home_novedades` (`id_novedades`, `titulo`, `imagen`, `url`, `orden`)
					 VALUES (NULL, '$titulo', '$imagen', '$url', '$orden');";
