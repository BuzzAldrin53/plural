...
<head>
	...
	<title>Categoria <?php echo $etiqueta_nombre; ?> - Plural</title>    
 		...
 		<div class="regalar">
 			 ...
 			 <div class="regalar_int">
	 			...
	 			<?php
	 			 ...
	 			 <div class="regalar_tit">Categoria <span style="font-weight: 600;"><?php echo $etiqueta_nombre; ?></span> </div>
	 			 ...
	 			 <div >
	 			 	<div style="background-color: #fff;">
						...
						$sy = "SELECT * FROM `categoria_xml_producto` WHERE id_categoria = '$idetiqueta' ";
