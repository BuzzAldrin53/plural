...
<head>
	...
	<title>Busqueda: <?php echo $buscar; ?> - Plural</title>    
		...
		<?php
 		...
 		<div class="regalar">
 			 ...
 			 <div class="regalar_int">
	 			 ...
	 			 <div class="regalar_tit">Busqueda: <span style="font-weight: 600;"><?php echo $buscar; ?></span> </div>
	 			 ...
	 			 <div >
	 			 	<div style="background-color: #fff;">
						...
						//$sz = " SELECT * FROM `xml_productos_clon` WHERE `id_producto` = '$id_producto_tmp' LIMIT 1";
						$sz = "SELECT * FROM xml_productos WHERE type LIKE '%$buscar%' OR ref LIKE '$buscar' OR extendedinfo LIKE '%$buscar%' LIMIT 24";
		 			 	...
		 			 	<div class="regalar_element">
					 		...
					 		if(isset($idu)){
		 			 		...
		 			 		<div class="regalar_precio" style="font-size: 15px; font-weight: 300; margin-top: 4px;">
		 			 			...
		 			 			<span style="font-size: 15px; font-weight: 600;">$<?php echo $precio; ?>.00</span>
		 			 		</div>
