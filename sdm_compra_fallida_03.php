...
<div id="salida2" style="position: absolute; display: none; top: 5px; left: 5px; font-family: verdana; font-size: 10px;">----</div>
 	...
 	<div class="content_all">
 		...
 		<div class="contenido">
 			...
 			<div style="width: 80%; margin: auto; background-color: #CDCBCC; border-radius: 20px; padding-top: 30px; padding-bottom: 30px;">
 				<div style="width: 300px; margin: auto;">
 					<img src="compra_no_pudo_realizarse.png" style="width: 100%;">
 				</div>
 			</div>


 				<div style="width: 40%; margin: auto; text-align: center; margin-top: 30px; color: #8F8F8F;">
 					Ya casi intenta con otro metodo de pago o
 				</div>


 				<div style="width: 40%; margin: auto; ">
 					
 					<a href="sdm_compra_tarjeta_03.php" style="color: #fff; text-decoration: none;">
 						<div class="boton_azul">Volver a intentar</div>
 					</a>
 					...
 					<a href="sdm_compra_tarjeta_03.php" style="color: #fff; text-decoration: none;">
 						<div class="boton_negro">Cambiar de forma de pago</div>
 					</a>
