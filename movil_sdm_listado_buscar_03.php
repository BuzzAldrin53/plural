...
<head>
	...
	<title><?php echo $buscar; ?> resultados - Plural</title>    
 		...
 		<div style="padding-bottom: 30px;">
 			 ...
 			 <div  style="padding-bottom: 60px;">
	 			...
	 			<?php
					...
					$sz = " SELECT count(*) FROM `xml_productos`
						 WHERE type like '%buscar%' OR name like '%$buscar%' OR otherinfo LIKE '%$buscar%' OR extendedinfo LIKE '%$buscar%' OR nombre_local LIKE '%$buscar%' 
						   ";
					$resuly = $mysqli->query($sz);
	 			 ...
	 			 <div class="regalar_tit">
	 			 	<span style="font-weight: 600;">Resultado de la busqueda de: <b><?php echo $buscar; ?></b></span> 
	 			 </div>
