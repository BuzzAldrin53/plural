		...
		<?php
 		...
 		<div class="regalar">
 			 ...
 			 <div class="regalar_int">
	 			 ...
	 			 <div class="regalar_tit"><?php echo $categoria_nombre; ?></div>
	 			 ...
	 			 <div >
	 			 	<div style="background-color: #fff;">
						...
						$sx = "SELECT * FROM `xml_categorias` WHERE `ref` = '$id_xml' ORDER BY `id_categoria` ASC LIMIT 1";
						//echo $sx;
						...
						$sy = "SELECT * FROM `xml_producto_categoria` WHERE `id_categoria` = '$xml_ref' LIMIT 15";
